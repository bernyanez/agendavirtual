//const { default: axios } = require("axios");
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendarEl = document.getElementById('agendaprofe');
        var calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          headerToolbar: {
           ...
           events:("http://localhost:8888/agenda/public/evento/calendarioprofesional/mostrar"),
        ...
        document.getElementById("btnGuardar").addEventListener("click",function(){
            ...
            enviarDatos("http://localhost:8888/agenda/public/evento/calendarioprofesional/agregar");//+formulario.id_users.value);
